  ...
  template: `
    <div class="w-full max-w-[480px] fade-in">
      ...
      <div class="grid gap-3">
        <!-- QR -->
        <lib-action-button (clicked)="methodSelected.emit('qr')">
          <svg icon width="20" height="20" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 11V4H11" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M37 4H44V11" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M44 37V44H37" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 44H4V37" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 24V12H24V24H12Z" fill="currentColor" stroke="currentColor" stroke-width="4" stroke-linejoin="round"/><path d="M30 18H36" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M30 12H36" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M30 24H36" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M30 30H36" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M12 30H24" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M12 36H24" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M30 36H36" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>
          Sử dụng mã QR
        </lib-action-button>
        ...
        <!-- Apple -->
        <lib-action-button (clicked)="methodSelected.emit('apple')">
          <svg icon width="18" height="20" viewBox="0 0 814 1000" fill="currentColor"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-37.3-155.5-127.4C46 835 0 696.3 0 562.6c0-209.4 137.4-319.5 272-319.5 67.2 0 123.4 44.5 165.8 44.5 40.8 0 104.9-47.4 176.1-47.4 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"/></svg>
          Tiếp tục với Apple
        </lib-action-button>
      </div>
